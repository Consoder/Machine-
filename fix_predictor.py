# save as fix_predictor.py in root folder and run it
import pathlib
...
class ReadmissionPredictor:
    ...
    def _input_to_dataframe(self, patient: PatientInput) -> pd.DataFrame:
        ...
        metformin_val = med_map.get(patient.metformin, 0)
        insulin_val   = med_map.get(patient.insulin, 0)
        data = {
        ...
        # Use the SAME feature engineer used during training to encode categoricals
