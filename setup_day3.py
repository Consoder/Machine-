...
# ── FILE 1: baseline.py ────────────────────────────
pathlib.Path("src/models/baseline.py").write_text(
"""import pandas as pd
import numpy as np
import joblib
import mlflow
...
# ── FILE 2: xgboost_model.py ───────────────────────
pathlib.Path("src/models/xgboost_model.py").write_text(
"""import pandas as pd
import numpy as np
import joblib
import mlflow
...
# ── FILE 3: train.py ───────────────────────────────
pathlib.Path("src/train.py").write_text(
"""import sys
from pathlib import Path
